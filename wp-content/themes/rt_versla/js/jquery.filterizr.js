        ...
        */
        _init: function(index, parent) {
            ...
            .css({
                ...
                'position': 'absolute',
                '-webkit-transition': '-webkit-transform ' + parent.options.animationDuration + 's ' + parent.options.easing + ' ' + self._calcDelay() + 'ms',
                'transition': 'transform ' + parent.options.animationDuration + 's ' + parent.options.easing + ' ' + self._calcDelay() + 'ms',
